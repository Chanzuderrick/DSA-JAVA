...
public class hashTables2 {
    public static void main(String[] args) {
        ...
        */
        ...
        Hashtable<String, String> table = new Hashtable<>(10, 0.5f); //initital capacity is usual 11 elements and load factor is 0.75
        ...
        for (String key : table.keySet()) { //keySet will take all of our keys and return a set, a set is iterable
           // System.out.println(key +"\t" + table.get(key)); display all elements and their keys
            ...
            //System.out.println(key.hashCode()  +"\t" + key +"\t" + table.get(key)); // the method earlier discussed
            System.out.println(key.hashCode() % 10 + "\t" + key + "\t" + table.get(key)); // we get collisions, we can increase the capacity
